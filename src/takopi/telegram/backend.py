    ...
    def build_and_run(
        ...
        *,
        ...
        cfg = TelegramBridgeConfig(
            ...
            voice_speechcore_api_key=settings.voice_speechcore_api_key,
            voice_speechcore_language=settings.voice_speechcore_language,
            voice_speechcore_diarize=settings.voice_speechcore_diarize,
